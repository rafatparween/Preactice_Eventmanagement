...
const Term = () => {
    return (
        <div className="bg-[#e5097f] text-white p-10">
            {/* Title */}
            ...
            <div className="space-y-8 text-[white] leading-relaxed">
                <section>
                    <h2 className="text-xl font-bold mb-2">Welcome to IJStartPrinter Work</h2>
                ...
                <section>
                    ...
                    <p>All intellectual property rights to the content created by IJStartPrinter Work for your project, such as website designs, software, applications, and marketing materials, remain the property of IJStartPrinter Work until full payment is received. Upon full payment, the intellectual property rights will be transferred to the client, except for any proprietary tools or pre-existing code used in the project.</p>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-2">6. Confidentiality</h2>
                    <p>We respect your confidentiality and will not disclose any proprietary information shared with us during the course of the project. Similarly, you agree not to disclose any proprietary tools, techniques, or processes used by IJStartPrinter Work.</p>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-2">7. Warranties and Liability</h2>
                    <p>We aim to deliver high-quality work, but IJStartPrinter Work does not guarantee that the service will be uninterrupted or error-free. Our services are provided “as is,” and we disclaim all warranties to the maximum extent permitted by law. In no event shall IJStartPrinter Work be liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use the services.</p>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-2">8. Termination</h2>
                    <p>Either party may terminate the agreement for services with written notice. If the client terminates the contract before the completion of the project, they are responsible for paying for all work completed up until the termination date. IJStartPrinter Work reserves the right to terminate the agreement if the client fails to comply with these terms or fails to make payment.</p>
                </section>
                ...
                <section>
                    ...
                    <p>IJStartPrinter Work reserves the right to update or change these Terms and Conditions at any time. The most current version will always be available on our website, and it is your responsibility to review them periodically.</p>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-2">11. Contact Us</h2>
                    <p>If you have any questions about these Terms and Conditions, please contact us at:</p>
                    <p>Email: <a href="mailto:support@ijstartprinter.com" className="underline">support@ijstartprinter.com</a></p>
