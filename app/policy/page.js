export default function Policy() {
    return (
      <div className="container mx-auto px-4 py-16  bg-[#e5097f] text-white">
        ...
        <div className="space-y-8 text-white">
          ...
          <section>
            ...
            <p>
              Welcome to ijstartprinter Work. We value your privacy and are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, and safeguard your data when you use our services or visit our website.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ijstartprinter Work may update this Privacy Policy from time to time. Significant changes will be communicated through a notice on our website. Changes will take effect immediately upon posting.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              Email: support@ijstartprinterwork.com <br />
              Phone: +1-800-555-1234 <br />
              Address: ijstartprinter Work, 123 Tech Drive, Innovation City, USA
            </p>
          </section>
